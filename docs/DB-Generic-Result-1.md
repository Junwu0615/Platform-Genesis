...
| :--: | :-- | :--: |
| [0](https://github.com/Junwu0615/OLTP-OLAP-Unified-DB/blob/main/docs/DB-Generic-Result-1.md#01initialize-pgbench-benchmark-data) | Initialize pgbench Benchmark Data | - |
| [1](https://github.com/Junwu0615/OLTP-OLAP-Unified-DB/blob/main/docs/DB-Generic-Result-1.md#1query-benchmark) | Query Benchmark | direct query method |
| [2](https://github.com/Junwu0615/OLTP-OLAP-Unified-DB/blob/main/docs/DB-Generic-Result-1.md#2oltp-workload-benchmark) | OLTP Workload Benchmark | use pgbench |
| [3](https://github.com/Junwu0615/OLTP-OLAP-Unified-DB/blob/main/docs/DB-Generic-Result-1.md#3olap-workload-benchmark) | OLAP Workload Benchmark | use pgbench |
| [4](https://github.com/Junwu0615/OLTP-OLAP-Unified-DB/blob/main/docs/DB-Generic-Result-1.md#4htap-workload-benchmark) | HTAP Workload Benchmark | use pgbench |
| [5](https://github.com/Junwu0615/OLTP-OLAP-Unified-DB/blob/main/docs/DB-Generic-Result-1.md#5saturation-benchmark) | Saturation Benchmark | use pgbench |
...
- #### *2.　OLTP Workload Benchmark*
  ...
  * c: client 數量 / j: thread 數量 / T: 測試秒數
  ...
  ```
- #### *[Docker Desktop vs. WSL2 ( Pure Read Performance )](https://github.com/Junwu0615/OLTP-OLAP-Unified-DB/blob/main/docs/DB-Generic-Result-2.md#docker-desktop-vs-wsl2--pure-read-performance-)*
