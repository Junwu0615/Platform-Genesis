...
| Deployment Delivery Baseline `K8s` | [Value of Deliverables 7](./docs/CI-CD.md)<br>怎麼交付比較有效率 ?<br>`Manual` vs. `GitOps` | 2026-06-13 |
...
| Deployment Governance `GitOps` | [Value of Deliverables 12](./docs/Deployment-Governance.md)<br>GitOps 怎麼治理叢集 ? | Expected in `202607` |
