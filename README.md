...
|:--|:--|:--|:--|
| _**[PG - Core](https://github.com/Junwu0615/PG-Core)**_ | _[v1.0.0 : Release on 2026-07-24](https://github.com/Junwu0615/PG-Core/discussions/1)_ | _Cloud Native_ | `Kubernetes` `GitOps`<br>`Observability`<br>`Infrastructure as Code`<br>`Secrets Management` |
...
>
> “*Platform Genesis focuses on integrating infrastructure automation, Kubernetes operations,<br>GitOps workflows, observability, governance, and reliability validation into a cohesive engineering system.*”
